...
1. Explain what a token is used for.
   Tokens are data that when carrying the right information allows access tothe server
2. What steps can you take in your web apps to keep your data secure?
   Create tokens to allow access
3. Describe how web servers work.
   The store data that is used across the web for web apps and websites
